...
function addTreeItem(name,action,code,isParent){
...
function showSonTree(treeCode){
    ...
    for(var i=0;i<_nameArray.length;i++){
        ...
        var treeItem = new WebFXTreeItem(_nameArray[i],_hrefArray[i],_codeArray[i]);
...
function WebFXTreeItem(sText, sAction, sCode, sTitle, sRightAction, sClass) {
...
function insertTreeItem(name,action,code,isParent,rightAction){
...
function showSonTrees(treeCode){
    ...
    for(var i=0;i<_nameArray.length;i++){
        ...
        var treeItem = new WebFXTreeItem(_nameArray[i],_hrefArray[i],_codeArray[i],_nameArray[i],_rightArray[i]);
