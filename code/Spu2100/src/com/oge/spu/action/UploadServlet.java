...
//					+ "imgs/" + request.getParameter("getfile"));
...
//			File file = new File(request.getServletContext().getRealPath("/")
//					+ "imgs/" + request.getParameter("delfile"));
			File file = null;
			if (file.exists()) {
...
//					+ "imgs/" + request.getParameter("getthumb"));
			System.out.println(request.getParameter("getthumb"));
			File file = new File("");
			if (file.exists()) {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			for (FileItem item : items) {
				if (!item.isFormField()) {
//					IOUtils.copy(item.getInputStream(), System.out);
//                    File file = new File(request.getServletContext().getRealPath("/")+"imgs/", item.getName());
