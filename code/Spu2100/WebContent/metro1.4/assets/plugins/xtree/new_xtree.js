...
WebFXTree.prototype.toString = function () {
    ...
    str += "<img align=absbottom id=\"" + this.id + "-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\""+this.action+"\"><a href=\"" + this.action + "\" id=\"" + this.text + "-anchor\" onmouseup=\"if(event.button==2){"+this.rgtAction+"}\" title=\""+this.title+"\" class=\""+this.css+"\">" + this.text + "</a></div>";
...
function WebFXTreeItem(sText, sAction,siwant, sTitle, sRightAction, sClass) {
...
WebFXTreeItem.prototype.toString = function (nItem,nItemCount) {//到字符串
...
//        alert (str);
        ...
        str += "<img align=absbottom id=\"" + this.id + "-icon\" src=\"" + this.icon + "\" onclick=\""+this.action+"\"><input type=\"checkbox\" name=\"checkwjc\" value=\""+this.iwant+"\" > " + this.text + "</a></div>";
...
WebFXTreeItem.prototype.ishavesubitem = function () {//是否有子目录
